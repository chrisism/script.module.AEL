...
AEL_platforms = [
    ...
    Platform('Amstrad CPC', 'computer-cpc', 'cpc', None, '4914', '60', '65', '46', DAT_NONE, 
             default_box_size=constants.BOX_SIZE_POSTER),

    # --- Atari ---
    Platform('Atari 2600', 'atari-2600', 'a2600', None, '22', '28', '26', '6',
        DAT_NOINTRO, 'Atari - 2600', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Atari 5200', 'atari-5200', 'a5200', None, '26', '33', '40', '20',
        DAT_NOINTRO, 'Atari - 5200', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Atari 7800', 'atari-7800', 'a7800', None, '27', '34', '41', '51',
        DAT_NOINTRO, 'Atari - 7800', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    Platform('Atari Jaguar', 'atari-jaguar', 'jaguar', None, '28', '17', '27', '72',
        DAT_NOINTRO, 'Atari - Jaguar (J64) (Parent-Clone)', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Atari Jaguar CD', 'atari-jaguarcd', 'jaguarcd', None, '29', '17', '171', '82',
        DAT_REDUMP, 'Atari - Jaguar CD Interactive Multimedia System - Datfile', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Atari Lynx', 'atari-lynx', 'lynx', None, '4924', '18', '28', '58',
        DAT_NOINTRO, 'Atari - Lynx', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Atari ST', 'computer-atari-st', 'atari-st', None, '4937', '24', '42', '38',
        DAT_NOINTRO, 'Atari - ST', default_box_size=constants.BOX_SIZE_POSTER),

    # --- Bandai ---
    Platform('Bandai WonderSwan', 'bandai-wswan', 'wswan', None, '4925', '48', '45', '90',
        DAT_NOINTRO, 'Bandai - WonderSwan', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Bandai WonderSwan Color', 'bandai-wswancolor', 'wswancolor', None, '4926', '49', '46', '95',
        DAT_NOINTRO, 'Bandai - WonderSwan Color', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    Platform('Commodore 64', 'computer-c64', 'c64', None, '40', '27', '66', '24',
        DAT_NOINTRO, 'Commodore - 64', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Commodore Amiga', 'computer-amiga', 'amiga', None, '4911', '19', '64', '39',
        DAT_NOINTRO, 'Commodore - Amiga', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    Platform('Commodore Amiga CD32', 'console-cd32', 'cd32', None, '4947', '56', '130', '70',
        DAT_REDUMP, 'Commodore - Amiga CD32 - Datfile', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    Platform('Commodore Amiga CDTV', 'console-cdtv', 'cdtv', None, None, '83', '129', None,
        DAT_REDUMP, 'Commodore - Amiga CDTV - Datfile', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    # --- MAME/Arcade ---
    Platform(PLATFORM_MAME_LONG, PLATFORM_MAME_SHORT, PLATFORM_MAME_COMPACT, None, '23', '143', '75', '2', DAT_MAME, default_box_size=constants.BOX_SIZE_SCREEN),
    ...
    Platform('Microsoft Xbox', 'microsoft-xbox', 'xbox', None, '14', '13', '32', '98', DAT_NONE,
             default_box_size=constants.BOX_SIZE_DVD),
    ...
    Platform('Microsoft Xbox One', 'microsoft-xboxone', 'xboxone', None, '4920', '142', None, '121', DAT_NONE,
             default_box_size=constants.BOX_SIZE_BLURAY),
    ...
    Platform('Nintendo 64', 'nintendo-n64', 'n64', None, '3', '9', '14', '84',
        DAT_NOINTRO, 'Nintendo - Nintendo 64 (BigEndian) (Parent-Clone)', default_box_size=constants.BOX_SIZE_WIDE),
    # Nintendo 64DD not found on MobyGames.
    Platform('Nintendo 64DD', 'nintendo-n64dd', 'n64dd', None, '3', '9', '122', '92',
        DAT_NOINTRO, 'Nintendo - Nintendo 64DD', default_box_size=constants.BOX_SIZE_WIDE),
    ...
    Platform('Nintendo DS', 'nintendo-nds', 'nds', None, '8', '44', '15', '108',
        DAT_NOINTRO, 'Nintendo - Nintendo DS (Decrypted) (Parent-Clone)', default_box_size=constants.BOX_SIZE_3DS),
    ...
    Platform('Nintendo DSi', 'nintendo-ndsi', 'ndsi', None, '8', '87', '15', '108',
        DAT_NOINTRO, 'Nintendo - Nintendo DSi (Decrypted) (Parent-Clone)', default_box_size=constants.BOX_SIZE_3DS),
    Platform('Nintendo e-Reader', 'nintendo-ereader', 'ereader', None, None, None, '119', None,
        DAT_NOINTRO, 'Nintendo - e-Reader'),
    Platform('Nintendo Famicon', 'nintendo-famicon', 'famicon', 'nes', default_box_size=constants.BOX_SIZE_WIDE),
    ...
    Platform('Nintendo Famicon Disk System', 'nintendo-fds', 'fds', None, '4936', '22', '106', '47',
        DAT_NOINTRO, 'Nintendo - Family Computer Disk System (FDS) (Parent-Clone)', default_box_size=constants.BOX_SIZE_WIDE),
    Platform('Nintendo GameBoy', 'nintendo-gb', 'gb', None, '4', '10', '9', '59',
        DAT_NOINTRO, 'Nintendo - Game Boy', default_box_size=constants.BOX_SIZE_SQUARE),
    Platform('Nintendo GameBoy Advance', 'nintendo-gba', 'gba', None, '5', '12', '12', '91',
        DAT_NOINTRO, 'Nintendo - Game Boy Advance', default_box_size=constants.BOX_SIZE_SQUARE),
    Platform('Nintendo GameBoy Color', 'nintendo-gbcolor', 'gbcolor', None, '41', '11', '10', '57',
        DAT_NOINTRO, 'Nintendo - Game Boy Color', default_box_size=constants.BOX_SIZE_SQUARE),
    Platform('Nintendo GameCube', 'nintendo-gamecube', 'gamecube', None, '2', '14', '13', '99',
        DAT_REDUMP, 'Nintendo - GameCube - Datfile', default_box_size=constants.BOX_SIZE_DVD),
    Platform('Nintendo NES', 'nintendo-nes', 'nes', None, '7', '22', '3', '41',
        DAT_NOINTRO, 'Nintendo - Nintendo Entertainment System (Parent-Clone)', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    Platform('Nintendo Switch', 'nintendo-switch', 'switch', None, '4971', '203', None, '124', DAT_NONE, 
             default_box_size=constants.BOX_SIZE_SLIM),
    ...
    Platform('Sega 32X', 'sega-32x', '32x', None, '33', '21', '19', '74',
        DAT_NOINTRO, 'Sega - 32X', default_box_size=constants.BOX_SIZE_DVD),
    ...
    Platform('Sega Dreamcast', 'sega-dreamcast', 'dreamcast', None, '16', '8', '23', '67',
        DAT_REDUMP, 'Sega - Dreamcast - Datfile', default_box_size=constants.BOX_SIZE_DVD),
    Platform('Sega Game Gear', 'sega-gamegear', 'gamegear', None, '20', '25', '21', '62',
        DAT_NOINTRO, 'Sega - Game Gear'),
    Platform('Sega Genesis', 'sega-genesis', 'genesis', 'megadrive', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Sega Master System', 'sega-sms', 'sms', None, '35', '26', '2', '49',
        DAT_NOINTRO, 'Sega - Master System - Mark III', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Sega Mega Drive', 'sega-megadrive', 'megadrive', None, '36', '16', '1', '54',
        DAT_NOINTRO, 'Sega - Mega Drive - Genesis', default_box_size=constants.BOX_SIZE_POSTER),
    Platform('Sega MegaCD', 'sega-megacd', 'megacd', None, '21', '20', '20', '65',
        DAT_REDUMP, 'Sega - Mega CD & Sega CD - Datfile', default_box_size=constants.BOX_SIZE_POSTER),
    ...
    Platform('Sega Saturn', 'sega-saturn', 'saturn', None, '17', '23', '22', '76',
        DAT_REDUMP, 'Sega - Saturn - Datfile', default_box_size=constants.BOX_SIZE_SLIM),
    ...
    Platform('Sony PlayStation', 'sony-psx', 'psx', None, '10', '6', '57', '78',
        DAT_REDUMP, 'Sony - PlayStation - Datfile', default_box_size=constants.BOX_SIZE_DVD),
    Platform('Sony PlayStation 2', 'sony-ps2', 'ps2', None, '11', '7', '58', '94',
        DAT_REDUMP, 'Sony - PlayStation 2 - Datfile', default_box_size=constants.BOX_SIZE_DVD),
    Platform('Sony PlayStation 3', 'sony-ps3', 'ps3', None, '12', '81', '59', '113', DAT_NONE, default_box_size=constants.BOX_SIZE_BLURAY),
    Platform('Sony PlayStation 4', 'sony-ps4', 'ps4', None, '4919', '141', None, '120', DAT_NONE, default_box_size=constants.BOX_SIZE_BLURAY),
    ...
    Platform('Sony PlayStation Portable', 'sony-psp', 'psp', None, '13', '46', '61', '109',
        DAT_REDUMP, 'Sony - PlayStation Portable - Datfile', default_box_size=constants.BOX_SIZE_SLIM),
